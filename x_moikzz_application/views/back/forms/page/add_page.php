    ...
    <div class="col-xlg-10 col-lg-9 col-md-8">
        <div class="card">
            <div class="card-body form-material">
                <h5 class="card-title b-b p-b-10">Create New Page</h5>
                <div class="form-group">
                    <small class="font-weight-bold">Page Title</small>
                    <input type="text" class="input-text form-control form-control-sm form-control-line" placeholder="" value="">
                </div>
                <div class="form-group">
        ...
        <div class="card">
            <div class="card-body">
                <div id="gal-accordian">
                    ...
                    <div id="collapse1" class="collapse show m-t-30" data-parent="#gal-accordian">
                        <div class="col-xlg-12">
                            <!-- Nav tabs -->
                            <ul class="nav nav-tabs customtab2 border-light" role="tablist">
                                <li class="nav-item"> <a class="nav-link show bg-light text-secondary active" data-toggle="tab" href="#settings" role="tab" aria-selected="true"><span class="sm-up"><i class="mdi mdi-chart-bar"></i></span> <span class="hidden-xs-down">Settings</span></a></li>
    ...
    <div class="col-xlg-2 col-lg-3 col-md-4 ">
        <div class="card">
            <div class="card-body">
                ...
                <a href="javascript:void(0)" class="btn btn-info m-b-10 p-10 btn-block waves-effect waves-light">Publish</a>
