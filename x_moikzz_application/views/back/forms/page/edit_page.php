...
<div class="row">
    <div class="col-xlg-10 col-lg-9 col-md-8 m-b-20">
        <a href="<?=site_url('/client/page/pages/create')?>" class="btn btn-outline-info btn-sm waves-effect waves-light float-left">Add New Page</a>    
    </div>
    <div class="col-xlg-10 col-lg-9 col-md-8">
        <div class="card">
            <div class="card-body form-material">
                <h5 class="card-title b-b p-b-10">Edit Page</h5>
