            ...
            <div class="col-sm-6 col-xs-12">
                <div class="b-best__info">
                    <header class="s-lineDownLeft b-best__info-head">
                        <h2>The Best &amp; the Largest Auto Dealer</h2>
                    </header>
                    <h6>Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmod etg tempor incididunt ut labore dolore magna aliqua. </h6>
                    ...
                    <a href="article.html" class="btn m-btn m-readMore">view listings<span class="fa fa-angle-right"></span></a>
                </div>
            </div>
            <div class="col-sm-6 col-xs-12">
                <iframe width="100%" height="315" src="https://www.youtube.com/embed/eYiDB4SidKk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                <!-- <img class="img-responsive center-block wow fadeIn" data-wow-delay=".8s" alt="best" src="<?=file_common_dir('front/media/about/best.jpg')?>" /> -->
            </div>
        </div>
    </div>
</section><!--b-best-->
        ...
        <div class="row">
            <div class="col-sm-4 col-xs-12">
                <div class="b-world__item">
                    <img class="img-responsive" src="<?=file_common_dir('front/media/370x200/wolks.jpg')?>" alt="wolks" />
            ...
            <div class="col-sm-4 col-xs-12">
                <div class="b-world__item">
                    <img class="img-responsive"  src="<?=file_common_dir('front/media/370x200/mazda.jpg')?>" alt="mazda" />
                    <div class="b-world__item-val">
            ...
            <div class="col-sm-4 col-xs-12">
                <div class="b-world__item">
                    <img class="img-responsive"  src="<?=file_common_dir('front/media/370x200/chevrolet.jpg')?>" alt="chevrolet" />
                    <div class="b-world__item-val">
