      ...
      <div id="carousel" class="slide carousel carousel-fade">
        <div class="carousel-inner">
          <div class="item active">
           <img src="<?=file_common_dir('front/media/banners/gallega-banner.jpg')?>" alt="sliderImg" />
            <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-xs-12">
                <div class="m-secondSelects">
                  ...
                  <div class="col-xs-4">
                    <input type="text" placeholder="Loads" class="form-control">
                    <p>Car loads?</p>
                  </div>
  ...
  <section class="b-featured" id="how-works">
    ...
    <!-- <section class="b-auto">
      <div class="container">
        ...
        <h2 class="s-title wow zoomInRight" data-wow-delay="0.3s" data-wow-offset="100">BEST OFFERS FROM GALLEGA GLOBAL LOGISTICS</h2>
        <div class="row">
              ...
              <div class="row m-margin" id="first">
                <div class="col-md-4 col-sm-6 col-xs-12">
                  <div class="b-auto__main-item wow slideInUp" data-wow-delay="0.3s" data-wow-offset="100">
                    <img class="img-responsive"  src="<?=file_common_dir('front/media/270x150/acura.jpg')?>" alt="mazda" />
                    <div class="b-world__item-val">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                  <div class="b-auto__main-item wow slideInUp" data-wow-delay="0.3s" data-wow-offset="100">
                    <img class="img-responsive"  src="<?=file_common_dir('front/media/270x150/nissan.jpg')?>" alt="mazda" />
                    <div class="b-world__item-val">
                      <span class="b-world__item-val-title">REGISTERED <span>2014</span></span>
                    </div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                  <div class="b-auto__main-item wow slideInUp" data-wow-delay="0.3s" data-wow-offset="100">
                    <img class="img-responsive"  src="<?=file_common_dir('front/media/270x150/acura2016.jpg')?>" alt="mazda" />
                    <div class="b-world__item-val">
                      <span class="b-world__item-val-title">REGISTERED <span>2014</span></span>
                    </div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                  <div class="b-auto__main-item wow slideInUp" data-wow-delay="0.3s" data-wow-offset="100">
                    <img class="img-responsive"  src="<?=file_common_dir('front/media/270x150/amg.jpg')?>" alt="mazda" />
                    <div class="b-world__item-val">
                      <span class="b-world__item-val-title">REGISTERED <span>2014</span></span>
                    </div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                  <div class="b-auto__main-item wow slideInUp" data-wow-delay="0.3s" data-wow-offset="100">
                    <img class="img-responsive"  src="<?=file_common_dir('front/media/270x150/brabus.jpg')?>" alt="mazda" />
                    <div class="b-world__item-val">
                      <span class="b-world__item-val-title">REGISTERED <span>2014</span></span>
                    </div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                  <div class="b-auto__main-item wow slideInUp" data-wow-delay="0.3s" data-wow-offset="100">
                    <img class="img-responsive"  src="<?=file_common_dir('front/media/270x150/range.jpg')?>" alt="mazda" />
                    <div class="b-world__item-val">
                      <span class="b-world__item-val-title">REGISTERED <span>2014</span></span>
                    </div>
    ...
    <section class="b-review">
      ...
      <!-- <img src="<?=file_common_dir('images/backgrounds/reviews.jpg')?>" alt="" class="img-responsive center-block" /> -->
		</section><!--b-review-->
